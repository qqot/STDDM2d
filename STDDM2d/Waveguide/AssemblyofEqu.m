function [Subdomain] = AssemblyofEqu(Subdomain,k0,dx,dy)
c=299792458*10^6;             % Speed of light
eps0=8.854e-18;
...
R0=100;
eta=377;
sigmax_max=(sigma_power+1)*R0/eta/2/(PMLnx*dx)/k0;
...
[i_grid, j_grid] = meshgrid(1:Totalnx, 1:Totalny);
i_grid = i_grid(:);
j_grid = j_grid(:);
